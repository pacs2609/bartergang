...
<section class="recommened">
    <div class="container">
        <header class="mb-2">
            <div class="row">
                <div class="col-md-12">
                    <p class="text-primary fw-600"><span class="rectangle"></span>Our Products</p>
                </div>
                <div class="col-md-10">
                    <p class="fs-3">Explore Our Products</p>
                </div>
                <div class="col-md-2 d-flex justify-content-end gap-1">
                    <a class="icon-btn rounded-circle"><i class="fa-solid fa-arrow-left"></i></a>
                    <a class="icon-btn rounded-circle"><i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </header>
        ...
        <div class="d-flex justify-content-center mt-4">
            <button class="btn btn-primary me-2 py-2 px-4">View All Products</button>
        </div>
    </div>
</section>
</template>
...
const {
    ...
    pending,
    error
} = await useFetch < Product[] > ('/api/products/getRecommened');
...
.parent-container {
  display: flex; /* หรือ block, flexbox อื่นๆ ที่เหมาะสม */
  justify-content: center; /* จัดกึ่งกลางในแนวนอน */
  align-items: center;   /* จัดกึ่งกลางในแนวตั้ง (ถ้าต้องการ) */
  /* หรือถ้า parent เป็น block element ปกติ */
  /* text-align: center; (ถ้า Grid Container เป็น inline-block) */
}
