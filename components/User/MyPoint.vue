  ...
  <div class="container p-5">
    ...
    <div class="flex justify-center">
      <div class="row" style="width: 600px;">
        ...
        <div class="col-md-5 flex">{{ formatNumber(data.bbcoin) }}</div>
        <div class="col-md-12 mb-2">
          <hr>
        </div>
        <div class="col-md-2 flex"><img src="/newimg/tmc.png" alt=""></div>
        <div class="col-md-5 flex text-primary">TMC</div>
        <div class="col-md-5 flex" v-if="data.OpenTMC">{{ formatNumber(data.tmccoin) }}</div>
        <div class="col-md-5 flex text-primary fw-300" v-else><a type="button" data-bs-toggle="modal"
            data-bs-target="#exampleModal">Open TMC Wallet</a></div>
        <div class="col-md-12 mb-2">
          <hr>
        </div>
        <div class="col-md-5 offset-md-2 flex">Total</div>
        <div class="col-md-5 flex">{{ formatNumber(data.total) }}</div>
      </div>
    </div>
  </div>
  <!-- Modal -->
...
const data = ref({
  ...
  OpenTMC: false,
  bbcoin: authStore.user?.bbcoin,
  total: authStore.user?.bbcoin
})

const OpenTMC = () => {
  const modalElement = document.getElementById('exampleModal');
  const checked = document.getElementById('flexCheckChecked');
  if (checked) {    if (!(checked as HTMLInputElement).checked) {
      Swal.fire({
        icon: 'error',
        title: "Error",
    ...
    data.value.OpenTMC = true;
    data.value.total = data.value.tmccoin + data.value.bbcoin;
  }
}
</script>
