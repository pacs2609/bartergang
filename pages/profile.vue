                ...
                <div class="row">
                    <div class="d-flex align-items-start col-md-3">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                            ...
                            <li class="tab-btn main-tab active" id="v-pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-profile" type="button" role="tab"
                                aria-controls="v-pills-profile" aria-selected="true"><i class="fa fa-user"></i>
                                บัญชีของฉัน</li>
                            <li class="tab-btn sub-tab" id="v-pills-changepass-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-changepass" type="button" role="tab"
                                aria-controls="v-pills-changepass" aria-selected="false">เปลี่ยนรหัสผ่าน</li>
                            <li class="tab-btn sub-tab " id="v-pills-my-bg-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-my-bg" type="button" role="tab" aria-controls="v-pills-my-bg"
                                aria-selected="false">BG ของฉัน</li>
                            <li class="tab-btn main-tab" id="v-pills-create-exchange-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-create-exchange" type="button" role="tab"
                                aria-controls="v-pills-create-exchange" aria-selected="false"><i
                                    class="fa fa-exchange"></i> นำเสนอแลกเปลี่ยน</li>
                            <li class="tab-btn sub-tab" id="v-pills-history-exchange-item-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-history-exchange-item" type="button" role="tab"
                                aria-controls="v-pills-history-exchange-item" aria-selected="false">ประวัติแลกของ</li>
                            <li class="tab-btn sub-tab" id="v-pills-history-exchange-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-history-exchange" type="button" role="tab"
                                aria-controls="v-pills-history-exchange" aria-selected="false">
                                ประวัติการนำเสนอแลกเปลี่ยน</li>
                            <li class="tab-btn main-tab" id="v-pills-voucher-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-voucher" type="button" role="tab"
                                aria-controls="v-pills-voucher" aria-selected="false"><i class="fa fa-tags"></i>Voucher
                            </li>
                            <li class="tab-btn main-tab" id="v-pills-alert-tab" data-bs-toggle="pill"
                                data-bs-target="#v-pills-alert" type="button" role="tab" aria-controls="v-pills-alert"
                                aria-selected="false"><i class="fa fa-bell"></i> การแจ้งเตือน</li>
                        </div>
                    </div>
                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                    ...
                                    <div class="panel-body">
                                        <div class="billing-fields row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="text" value="lineid" placeholder="Line ID" id="line"
                                                    name="line" class="form-control mydata">
                                                <br>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <center><input type="button" value="แก้ไขข้อมูล" name="signup"
                                                        class="btn btn-primary"></center><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-changepass" role="tabpanel"
                            ...
                            <div class="profile-content">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form id="changepass-form" action="" autocomplete="off"
                                            ...
                                            <div class="billing-fields row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <input type="text" value="" placeholder="รหัสผ่านเก่า" id="oldpass"
                                                        name="oldpass" class="form-control" required=""
                                                        autocomplete="off">
                                                    <p id="eoldpass" class="help-block err"
                                                        style="display:none;color:red">*กรุณาใส่
                                                        รหัสผ่านเก่า</p>
                                                    <br>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="password" value="" placeholder="รหัสผ่านใหม่"
                                                        id="newpass" name="newpass" @blur="checkPasswordStrength()"
                                                        class="form-control" required="">
                                                    <p id="enewpass" class="help-block err"
                                                        style="display:none;color:red">*กรุณาใส่
                                                        รหัสผ่าน</p>
                                                    <p id="password-strength-status" class="strong-password"
                                                        style="color: green;">สามารถใช้ได้</p>
                                                    <br>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <label class="" for="repass">ยืนยันรหัสผ่านใหม่<font color="red">
                                                            *</font></label>
                                                    <input type="password" value="" placeholder="ยืนยันรหัสผ่านใหม่"
                                                        id="repass" name="repass" @blur="checkPasswordStrength()"
                                                        class="form-control" required="">
                                                    <p id="erepass" class="help-block err"
                                                        style="display:none;color:red">*กรุณาใส่
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 2rem">
                                                    <center><input type="submit" value="แก้ไขข้อมูล" name="signup"
                        ...
                        <div class="tab-pane fade" id="v-pills-my-bg" role="tabpanel"
                            aria-labelledby="v-pills-my-bg-tab">
                            <div class="profile-content">
                                <div class="panel panel-default bg-sum-item">
                                    <div class="card-header bg-transparent d-flex justify-content-between">
                                        ...
                                        <div>
                                            <span class="text-muted fs-7"><i class="fa fa-calendar"
                                                    aria-hidden="true"></i> 05/09/2019</span>
                                            <span class="text-muted fs-7 bg-sum-item-sum" style="margin-left:10px;"><i
                                                    class="fa fa-clock-o" aria-hidden="true"></i> 13:54:14</span>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <font color="green" class="fs-7">รายการเพิ่มเหรียญ</font><br> <span
                                                    class="fs-7 text-muted">หมายเหตุ : จากการอนุมัติสินค้า หมายเลข
                                                    B0000000157</span>
                                            </div>
                                            <div class="col-sm-3 text-right fs-7" style="color:blue">15,000.00</div>
                                            <div class="col-sm-3 text-right"><span
                                                    class="fs-7 text-muted">คงเหลือ</span><span
                                                    class="fs-7 text-primary bg-sum-item-sum"> 15,000.00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default bg-sum-item">
                                    <div class="panel-heading">
                                        <div class="card-header bg-transparent d-flex justify-content-between">
                                            ...
                                            <div class="text-right"><span class="fs-7 text-muted"><i
                                                        class="fa fa-calendar" aria-hidden="true"></i> 06/09/2019</span>
                                                <span class="fs-7 text-muted" style="margin-left:10px;"><i
                                                        class="fa fa-clock-o" aria-hidden="true"></i> 15:41:43</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-right"><span class="fs-7">คงเหลือ</span> <span
                                                    class="text-primary bg-sum-item-sum fs-7">15,000.00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default bg-sum-item">
                                    <div class="card-header bg-transparent d-flex justify-content-between">
                                        ...
                                        <div class="text-right"><span class="fs-7 text-muted"><i class="fa fa-calendar"
                                                    aria-hidden="true"></i> 09/09/2019</span>
                                            <span class="fs-7 text-muted" style="margin-left:10px;"><i
                                                    class="fa fa-clock-o" aria-hidden="true"></i> 12:30:42</span>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 text-right"><span
                                                    class="fs-7 text-muted">คงเหลือ</span><span
                                                    class="text-primary bg-sum-item-sum fs-7"> 69.00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-create-exchange" role="tabpanel"
                            aria-labelledby="v-pills-create-exchange-tab">
                            <div class="profile-content">
                                <div class="panel panel-default">
                                    <div class="panel-heading">นำเสนอแลกเปลี่ยน</div>
                                    <div class="panel-body">
                                        <form id="announce-form" method="post" action="/saveproduct/"
                                            enctype="multipart/form-data" autocomplete="off">
                                            <div class="form-group">
                                                <label for="inputName" class="control-label">ชื่อสินค้า</label>
                                                <div class="">
                                                    <input type="text" name="name" id="name" maxlength="50"
                                                        placeholder="กรอกชื่อสินค้า.." class="form-control">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select class="form-control" id="item_condition"
                                                        name="item_condition" tmt:invalidindex="0"
                                                        tmt:message="กรุณาเลือก สภาพสินค้า"
                                                        title="กรุณาเลือก สภาพสินค้า">
                                            ...
                                            <div class="form-group" id="showp" style="display: none;">
                                                <label class="form-control" for="percent"
                                                    style="display:none">สภาพสินค้ามือสอง (เปรียบเทียบสินค้าใหม่คือ
                                                ...
                                                <input type="text" class="col-md-10 col-sm-offset-2" value=""
                                                    placeholder="กรอกเปอร์เซ็นต์" id="percent" name="percent">
                                                <span id="errmsg1" style="color:red"></span>
                                                <br><br>
                                            </div>
                                            <div class="form-group" id="showp2" style="display:none">
                                                <label class="control-label" for="remark">ตำแหน่งที่มีรอยตำหนิ<font
                                                ...
                                                <textarea class="col-md-10" name="remark" id="remark"
                                                    rows="10"></textarea>
                                                <br><br>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input class="form-control" type="text" value=""
                                                        placeholder="BG ที่ต้องการ" id="price" name="price">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input class="form-control" type="text" value=""
                                                        placeholder="จำนวนสินค้า" id="qty" name="qty">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 ">
                                                    <input type="button" value="ส่งข้อมูล" name="ส่งช้อมูล"
                        ...
                        <div class="tab-pane fade" id="v-pills-history-exchange-item" role="tabpanel"
                            aria-labelledby="v-pills-history-exchange-item-tab">
                            <div class="profile-content">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-history-exchange" role="tabpanel"
                            aria-labelledby="v-pills-history-exchange-tab">
                            <div class="profile-content">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="v-pills-voucher" role="tabpanel"
                            aria-labelledby="v-pills-voucher-tab">
                            <div class="profile-content">
                                <div class="panel panel-default bg-sum-item">
                                    <div class="panel-body">
                                            ...
                                            <form action="https://www.bartergang.net/refill_voucher.php" method="post">
                                                <div class="billing-fields row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <input type="text" value="" placeholder="กรุณากรอก รหัส Voucher"
                                                            id="voucher" name="voucher" class="form-control">
                                                        <p id="evoucher" class="help-block err"
                                                            style="display:none;color:red">*กรุณากรอก รหัส Voucher</p>
                                                    </div>
                                                    <div class="col-md-12 col-sm-12 col-xs-12 mt-15"> <button
                                                            type="submit" value="ใช้ Voucher"
                                                            class="btn btn-primary">ใช้ Voucher</button> </div>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-alert" role="tabpanel"
                            aria-labelledby="v-pills-alert-tab">
                            <div class="profile-content">
                            </div>
                        </div>
                    </div>
