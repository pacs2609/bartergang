    ...
    <section class="pages">
        <div class="login-area pt-30">
            <div class="container">
                ...
                <div class="row">
                    <form id="register-form" action="" autocomplete="off" onsubmit="return false;">
                        <div class="clear"></div>
                        <div class="col-md-8 offset-md-2">
                            <div class="billing-fields row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="firstname">ชื่อ<font color="red"> *</font></label>
                                    <input type="text" name="firstname" id="firstname" placeholder="ชื่อ " class="form-control mydata empty" style="overflow:hidden;" required="">
                                    <p id="efirstname" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        ชื่อ</p>
                                    <br><br>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="lastname">นามสกุล<font color="red"> *</font></label>
                                    <input type="text" name="lastname" id="lastname" placeholder="นามสกุล" class="form-control mydata empty" required="">
                                    <p id="elastname" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        นามสกุล</p>
                                    <br><br>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="email">อีเมลล์<font color="red"> *</font></label>
                                    <input type="text" name="email" id="email" placeholder="อีเมลล์" class="form-control mydata empty email" required="">
                                    <p id="eemail" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        อีเมลล์</p>
                                    <br><br>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <label for="tel">เบอร์โทรศัพท์<font color="red"> *</font></label>
                                    <input type="text" name="tel" id="tel" placeholder="เบอร์โทรศัพท์" class="form-control mydata empty" required="">
                                    <p id="etel" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        เบอร์โทรศัพท์</p>
                                    <br><br>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <label for="address">ที่อยุ่<font color="red"> *</font></label>
                                    <textarea name="address" id="address" cols="30" rows="5" placeholder="ที่อยู่" class="form-control mydata empty" required=""></textarea>
                                    <p id="eaddress" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        ที่อยุ่</p>
                                    <br><br>
                                </div>
                                <!-- <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" value="" placeholder="Username" id="username" name="username"
                                        class="form-control mydata empty" required="" autocomplete="off">
                                    <p id="eusername" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        Username</p>
                                    <br><br>
                                </div> -->
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    <label class="" for="password">รหัสผ่าน<font color="red"> *</font></label>
                                    <input type="password" value="" placeholder="รหัสผ่าน" id="password" name="password" onblur="checkPasswordStrength()" class="form-control mydata empty" required="">
                                    <p id="epassword" class="help-block err" style="display:none;color:red">*กรุณาใส่
                                        รหัสผ่าน</p>
                                    <p id="password-strength-status" class="strong-password" style="color: green;">
                                        สามารถใช้ได้</p>
                                    <br><br>
                                </div>
                                <div class="col-md-12 col-sm-6 col-xs-12">
                                    <label class="" for="repass">ยืนยันรหัสผ่าน<font color="red"> *</font></label>
                                    <input type="password" value="" placeholder="ยืนยันรหัสผ่าน" id="repass" name="repass" onblur="checkPasswordStrength()" class="form-control mydata empty" required="">
                                ...
                                <!-- <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" value="" placeholder="Line ID" id="line" name="line"
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input type="submit" value="สมัครสมาชิก" name="signup" id="signup"
